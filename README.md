...
## Recap
- Starting from step #5, a kernel build configuration that enabled all targets which could be built as a module to be enabled was generated.
...
# Secureboot / IMA / EVM
I'm open to suggestions (I've never been able to get secure boot to work) and a few additional tools are required:
